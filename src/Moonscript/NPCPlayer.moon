...
class Player 
  ...
  say: (msg, to, hostility) =>
    -- new ChatBubble instance
    --- @TODO !implement: ChatBubble[.VisibleTo, \setVirtualParent, \setOffset, \setColor, \getColorByHostility]
    with ChatBubble tostring msg
      -- Set to whom the chat bubble is visible. Can be a table, string, Player, or Character
      .VisibleTo = to
      -- This is who the ChatBubble is centered over
      \setVirtualParent @
      -- Set the rotational offset of the ChatBubble
      \setOffset Vector3.new 0, 3, 0
      -- Set the color of the ChatBubble according to the hostility of the message.
      \setColor \getColorByHostility hostility
return NPCPlayer