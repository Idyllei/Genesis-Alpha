...
class U_API  -- Utility Singleton
  _INVENTORY = require 'U_INVENTORY' -- TODO: Reqrite `Inventory.moon`
  _PLAYER_SETTINGS = require 'U_PLAYER_SETTINGS' -- TODO: Rewrite `PlayerSettings.moon`
  _CONFIG = require 'TOWNS.config'
